...
ALLOWED_HOSTS = [
    ...
    'boutique-ado-test-462dce9494f9.herokuapp.com',  # heroku application
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'allauth.accounts.context_processors.account',
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = "boutique-ado-test-462dce9494f9.herokuapp.com"
